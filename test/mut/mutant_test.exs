defmodule Mut.MutantTest do
  ...
  test "JSON round-trip has expected keys and excludes AST fields" do
    ...
    assert decoded |> Map.keys() |> Enum.sort() ==
             ~w(ast_path_hash column compile_error covering_tests description duration_ms end_byte engine file function id killing_test killing_test_file line module mutated_source mutation_kind mutator mutator_name original_dispatch original_source skip_reason source_patch span stable_id stable_id_kind start_byte status)
