defmodule Mut.Mutator.ComparisonNegation do
  @moduledoc "Mutates comparison operators to logical negations."
  ...
  @impl true
  def name, do: "ComparisonNegation"

  @impl true
  def description, do: "Replace comparison operators with negations."
