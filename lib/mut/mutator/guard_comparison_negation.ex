defmodule Mut.Mutator.GuardComparisonNegation do
  @moduledoc "Mutates guard comparison operators to logical negations."
  ...
  @accepted_names ~w(< <= > >= == != === !==)a
  @arity 2
  @kind :guard_comparison_negation
  @replacements %{
    :< => [:>=],
    :<= => [:>],
    :> => [:<=],
  ...
  @impl true
  def name, do: "GuardComparisonNegation"

  @impl true
  def description, do: "Replace guard comparison operators with negations."
