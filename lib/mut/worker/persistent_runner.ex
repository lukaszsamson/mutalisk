defmodule Mut.Worker.PersistentRunner do
  ...
  defp reset_leaks(%{leak_baseline: %{} = baseline}, diag_enabled?) do
    if diag_enabled? do
      ...
      {_, ecto_us} = Diag.time(fn -> Reset.reset_ecto() end)
      {_, pool_us} = Diag.time(fn -> Reset.reset_pool_apps() end)
      ...
      %{
        ...
        reset_mox_us: mox_us,
        reset_ecto_us: ecto_us,
        reset_pool_us: pool_us
      }
    else
